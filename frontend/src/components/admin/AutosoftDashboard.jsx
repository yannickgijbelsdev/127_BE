        ...
        <div className="flex gap-2">
          <button
            ...
            className={`px-3 py-1.5 rounded text-sm font-medium transition-colors ${
              platformFilter === 'all' ? 'bg-gray-600 text-white' : 'bg-[#202124] text-gray-400 hover:bg-[#303134]'
            }`}
          >
            Alle Platforms
          </button>
          <button
            ...
            className={`px-3 py-1.5 rounded text-sm font-medium transition-colors flex items-center gap-1 ${
              platformFilter === 'Windows' ? 'bg-blue-600 text-white' : 'bg-[#202124] text-gray-400 hover:bg-[#303134]'
            }`}
          >
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded text-sm font-medium transition-colors flex items-center gap-1 ${
              platformFilter === 'macOS' ? 'bg-gray-600 text-white' : 'bg-[#202124] text-gray-400 hover:bg-[#303134]'
            }`}
          >
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded text-sm font-medium transition-colors flex items-center gap-1 ${
              platformFilter === 'Android' ? 'bg-green-600 text-white' : 'bg-[#202124] text-gray-400 hover:bg-[#303134]'
            }`}
          >
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded text-sm font-medium transition-colors flex items-center gap-1 ${
              platformFilter === 'iOS' ? 'bg-gray-500 text-white' : 'bg-[#202124] text-gray-400 hover:bg-[#303134]'
            }`}
          >
            <Smartphone className="w-3 h-3" />
            iOS
